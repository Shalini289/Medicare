...
const features = [
  ...
  },
  {
    ...
    href: "/prescriptions",
    description: "Prescription upload workflow for extracting medicine names, dosage, and adherence support.",
  ...
  },
  {
    ...
    icon: FaRupeeSign,
    href: "/admin",
    description: "Fintech-healthcare module idea for predicting EMI eligibility and recommended healthcare payment plans.",
