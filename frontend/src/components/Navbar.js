...
const navGroups = [
  {
    ...
    items: [
      ...
      { label: "Live Queue", href: "/appointment-queue" },
      { label: "Health EMI", href: "/health-emi" },
      { label: "Offline Clinic", href: "/offline-clinic", roles: ["doctor"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Prescription Analyzer", href: "/prescription-analyzer" },
